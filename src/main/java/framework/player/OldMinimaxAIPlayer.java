...
public abstract class OldMinimaxAIPlayer extends AIPlayer {
    ...
    public OldMinimaxAIPlayer(Board board, String name, AIDifficulty difficulty) {
        super(board, name);

        this.difficulty = difficulty;
    }

    public OldMinimaxAIPlayer(Board board, AIDifficulty difficulty) {
        super(board);
